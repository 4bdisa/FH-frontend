...
const CreateAdmin = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`${import.meta.env.VITE_API_URL}/api/admin/createAdmin`, { // Replace with your actual API endpoint
                method: 'POST',
                headers: {
            ...
            // Optionally redirect to login page or admin list page
